...
<div class="description">
    ...
    <p>
        ...
        momenten waarin
        jij op je best was, zegt dit wat over jouw persoonlijke kracht of vaardigheden.
    </p>
</div>
...
<div class="actions">
    ...
    <div class="right">
        <a class="button big" href="/experience/completion/intro.php" for="submit_experience_form" onclick="return nextExperience()">Volgende</a>
    </div>
</div>
